...
window.UVSTUDIO_LOCALES.en = {
  ...
  "slotsDescription": "Store several Fusion firmwares on the radio and pick one at boot (hold MENU). Writing only touches the external flash, so the radio stays usable.",
  "slotColIdx": "#",
